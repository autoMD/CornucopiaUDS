...
public extension UDS {
    ...
    enum OBD2 {
        ...
        static let messageSpecs: [MessageSpec] = [
            ...
            MessageSpec(sid: ServiceId.currentPowertrainDiagnosticsData, pid: CurrentPowertrainDiagnosticsDataType.engineCoolantTemperature, mnemonic: "COOLANT_TEMP", len: 1, converter: .uint8, unit: UnitTemperature.celsius),                 // 0105
